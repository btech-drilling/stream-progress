...
// วันที่กรรมการอนุมัติแผน
export const PLAN_APPROVAL_DATE = '2026-08-17';

// วันที่เริ่มเก็บตัวอย่างตามแผน
// ใช้เป็นจุดเริ่มคำนวณ Daily Target
export const COLLECTION_START_DATE = '2026-08-18';

// วันสุดท้ายที่ระบบติดตาม Progress
export const PROGRESS_END_DATE = '2026-10-15';
...
export const ITEMS = {
  ...
  heavy_stream: {
    key: 'heavy_stream',
    label: 'ตัวอย่างแร่หนักจากตะกอนท้องน้ำ',
    total: 418,
    batches: MAIN_BATCHES,
  },
  ...
  heavy_weathered: {
    key: 'heavy_weathered',
    label: 'ตัวอย่างแร่หนักจากชั้นดินผุพัง',
    total: 418,
    batches: MAIN_BATCHES,
  },
